export const config = {
  ...
  USERS: [
    {
      ...
      id: "oW6UL67A79Bm_QuboR6TWodcgc1Y",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oqrvu2QGGGfVjsbvgN-p2DdetOeqrbM_YFLXQQyoEvw",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2000", "date": "09-12"},
       // {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
     //   {"type": "生日", "name": "老婆", "year": "1996", "date": "09-31"},
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "老婆", "year": "2000", "date": "09-12", isShowAge: true},
    {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {"type": "生日", "name": "李四", "year": "2000", "date": "09-12", isShowAge: true},
    {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-01"},
    // 你可以不断按格式往下增加
    // ...
  ],
